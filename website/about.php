                ...
                <div class="row">
                    <div class="offset-xl-1 col-lg-8">
                        <div class="about-details-cap mb-50">
                            <h4>O objetivo</h4>
                            <p>Queremos reduzir o consumismo fomentado pelas grandes corporações.
                            </p>
                            <p>Como tal, a venda de roupas em segunda-mão, faz com que se reutilizem as peças que não utilizamos, e se evitem as idas às lojas e shoppings.</p>
                        </div>

                        <div class="about-details-cap mb-50">
                            <h4>Como ajudar?</h4>
                            <p>Basta listar uma peça ou acessório na página "Vender roupa".
                            </p>
                            <p>Depois de preencher os campos e submeter algumas imagens, já está!</p>
                        </div>
                    </div>
                </div>
            </div>
